...
from nicky.modules.sql import afk_sql as sql
from nicky.modules.users import get_user_id

from nicky.modules.helper_funcs.alternate import send_message
            ...
            if sql.is_afk(user_id):
                ...
                if valid:
                    if not reason:
                        ...
                        res = f"<b>{fst_name}</b> hi a hman rih lo! a hman loh chhan chu \n{reason}"
                    send_message(
...
def __user_info__(user_id):
    ...
    text = "<b>A la hman rihlo</b>: {}"
    if is_afk:
        text = text.format("Aw")

    else:
        text = text.format("Aih")
    return text
