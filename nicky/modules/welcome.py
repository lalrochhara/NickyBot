...
import nicky.modules.sql.welcome_sql as sql
from nicky.modules.sql.global_bans_sql import is_user_gbanned
from nicky import dispatcher, OWNER_ID, LOGGER, MESSAGE_DUMP, spamwtc
...
from nicky.modules.helper_funcs.msg_types import get_welcome_type
        ...
        for new_mem in new_members:
            ...
            # Make bot greet admins
                ...
                context.bot.send_message(
                    MESSAGE_DUMP,
                    "nicky have been added to <pre>{}</pre> with ID: \n<pre>{}</pre>".format(
                        chat.title, chat.id
                    ),
                    parse_mode=ParseMode.HTML,
                )
