...
from nicky import dispatcher, LOGGER
...
from nicky.modules.helper_funcs.extraction import extract_user_and_text
from nicky.modules.helper_funcs.string_handling import extract_time
from nicky.modules.helper_funcs.admin_rights import user_can_ban
...
def kick(update, context):
    ...
    if res:
        ...
        message.reply_text("Chhuak maiteh!.")
...
def banme(update, context):
    ...
    if res:
        update.effective_message.reply_text("Aw, i ti dik chiah e! GTFO..")
        log = (
            "<b>{}:</b>"
            "\n#BANME"
            "\n<b>User:</b> {}"
...
def kickme(update, context):
    ...
    if res:
        update.effective_message.reply_text("Nia, i ti dik e chhuak maiteh!..")
    else:
        update.effective_message.reply_text("Huh? I can't :/")
...
def unban(update, context):
    ...
    message.reply_text("A ṭha, an rawn lut ṭha leh thei ang!")
