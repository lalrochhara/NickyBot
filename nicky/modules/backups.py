...
import nicky.modules.sql.notes_sql as sql
from nicky import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from nicky.__main__ import DATA_IMPORT
from nicky.modules.helper_funcs.chat_status import user_admin
from nicky.modules.helper_funcs.alternate import typing_action

# from nicky.modules.rules import get_rules
import nicky.modules.sql.rules_sql as rulessql

# from nicky.modules.sql import warns_sql as warnssql
import nicky.modules.sql.blacklist_sql as blacklistsql
from nicky.modules.sql import disable_sql as disabledsql

# from nicky.modules.sql import cust_filters_sql as filtersql
# import nicky.modules.sql.welcome_sql as welcsql
import nicky.modules.sql.locks_sql as locksql
from nicky.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("nicky{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("nicky{}.backup".format(chat_id), "rb"),
        caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `nicky-Backup` is specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("nicky{}.backup".format(chat_id))  # Cleaning file
