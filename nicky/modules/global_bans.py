...
import nicky.modules.sql.global_bans_sql as sql
from nicky import (
    dispatcher,
    OWNER_ID,
    SUDO_USERS,
...
from nicky.modules.helper_funcs.chat_status import user_admin, is_user_admin
from nicky.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from nicky.modules.helper_funcs.filters import CustomFilters
from nicky.modules.helper_funcs.alternate import typing_action, send_action
from nicky.modules.sql.users_sql import get_all_chats
...
def __user_info__(user_id):
    ...
    if is_gbanned:
        ...
        if user.reason:
            ...
            text += "\n\nAppeal at @nickybot if you think it's invalid."
    else:
        text = text.format("No")
    return text
...
nicky will constantly help banning spammers off from your group automatically So, you don't have to worry about spammers storming your group[.](https://telegra.ph/file/c1051d264a5b4146bd71e.jpg)
"""
